...
public class AddFoodToCartIT extends BaseIT {
    ...
    @Test
    public void successAddFood() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart(userEmail, fid1, 1);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void nullUserId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart(null, fid1, 1);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void emptyUserId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart("", fid1, 1);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void whiteSpaceUserID() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart("    ", fid1, 1);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void wrongFormatUserId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart("sd@tecnico", fid1, 1);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void notRegisteredUserId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart("sd@tecnico.ulisboa.pt", fid1, 1);
    }
    ...
    public void nullFoodId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart("sd@tecnico", null, 1);
    }
    ...
    public void wrongFoodId() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        ...
        fid.setMenuId("ola");
        client.addFoodToCart("sd@tecnico", fid, 1);
    }

    @Test(expected = InvalidFoodQuantityFault_Exception.class)
    public void zeroQuantity() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart(userEmail, fid1, 0);
    }

    @Test(expected = InvalidFoodQuantityFault_Exception.class)
    public void negQuantity() throws InvalidFoodIdFault_Exception, InvalidUserIdFault_Exception, InvalidFoodQuantityFault_Exception  {
        client.addFoodToCart(userEmail, fid1, -1);
    }
