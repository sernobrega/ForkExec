...
public class SearchHungryIT extends BaseIT {
    ...
    @Test
    public void successHungry() throws InvalidTextFault_Exception {
        List<Food> foods = client.searchHungry("Entree");
        Assert.assertEquals(foods.size(), 3);
        Assert.assertTrue(foods.get(0).getPreparationTime() <= foods.get(1).getPreparationTime());
    }

    @Test
    public void succcessRestaurant2() throws InvalidTextFault_Exception {
        List<Food> foods = client.searchHungry("3");
